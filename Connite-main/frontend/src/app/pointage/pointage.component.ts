...
@Component({
   ...
   <h2>Id_ouvrier : {{pointage.id_ouvrier}}, Id_chantier : {{pointage.id_chantier}}, Heures :{{pointage.heures}}, Galerie: {{pointage.galerie}},date:{{pointage.date}}, Prime Habillement : {{pointage.habillement}}, Prime Machine:{{pointage.machine}}</h2>
